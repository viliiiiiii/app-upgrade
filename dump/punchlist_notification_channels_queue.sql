...
--
-- Dumping data for table `notification_channels_queue`
--

LOCK TABLES `notification_channels_queue` WRITE;
/*!40000 ALTER TABLE `notification_channels_queue` DISABLE KEYS */;
/*!40000 ALTER TABLE `notification_channels_queue` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2025-11-02 22:36:58
